...
{
    public string horizontalMoveKeys;
    public string verticalMoveKeys;
    ...
    void FixedUpdate()
    {
        ...
        movementVector = new Vector2(Input.GetAxis(horizontalMoveKeys) * speedX * Time.fixedDeltaTime, Input.GetAxis(verticalMoveKeys) * speedY * Time.fixedDeltaTime);
